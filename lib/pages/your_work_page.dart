...
class YourWorksPage extends StatefulWidget {
  const YourWorksPage({super.key});

  @override
  State<YourWorksPage> createState() => _YourWorksPageState();
}

class _YourWorksPageState extends State<YourWorksPage> {
  
  // Sample data for user's works
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              leading: const PhosphorIcon(PhosphorIconsRegular.trash, color: Colors.red),
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              // Bottom row with collaborators and status
                              Row(
                                children: [
                                  // Collaborators
                                  PhosphorIcon(
